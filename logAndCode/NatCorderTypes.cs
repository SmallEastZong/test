...
namespace NatCorderU.Core {
    ...
    public struct Configuration {
        ...
        public static Configuration Screen { get { return new Configuration(Display.width/2, Display.height/2, 30, (int)(960 * 540 *5f), 3); }}
        /// <summary>
    ...
    public sealed class Frame { // We make it a class instead of struct so we get reference equality
        ...
        public Frame (RenderTexture surface, long timestamp = -1) {
            ...
            this.timestamp = timestamp >= 0 ? timestamp : CurrentTimestamp;
        }
